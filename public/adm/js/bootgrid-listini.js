$(document).ready(function(){
                ...
                }).on("loaded.rs.jquery.bootgrid", function()
                {
                    ...
                    {
                        window.location.href = "/admin/prodotti/listini-prodotti/" + $(this).data("row-id") + "/modifica";
                    ...
                    }).end().find(".command-delete").on("click", function(e)
                    {
                            ...
                            rows[0] = id;
                                ...
                                swal({   
                                    title: "Sei sicuro di voler cancellare questo listino?",   
                                    ...
                                    swal("Cancellato!", "Listino cancellata con successo.", "success"); 
                                    deleteResource(id, 'prodotti/listini-prodotti');
