$(document).ready(function(){
                ...
                }).on("loaded.rs.jquery.bootgrid", function()
                {
                    ...
                    {
                        window.location.href = "/admin/voci-menu/" + $(this).data("row-id") + "/modifica";
                    ...
                    }).end().find(".command-delete").on("click", function(e)
                    {
                            ...
                            rows[0] = id;
                                ...
                                swal({   
                                    title: "Sei sicuro di voler cancellare questa voce menu?",   
                                    ...
                                    swal("Cancellato!", "La voce menu è stata cancellata con successo.", "success"); 
                                    deleteResource(id, 'voci-menu');
