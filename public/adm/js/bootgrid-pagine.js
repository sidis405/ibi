$(document).ready(function(){
                ...
                }).on("loaded.rs.jquery.bootgrid", function()
                {
                    ...
                    {
                        window.location.href = "/admin/pagine/" + $(this).data("row-id") + "/modifica";
                    ...
                    }).end().find(".command-delete").on("click", function(e)
                    {
                            ...
                            rows[0] = id;
                                ...
                                swal({   
                                    title: "Sei sicuro di voler cancellare questa pagina?",   
                                    ...
                                    swal("Cancellato!", "La pagina è stato cancellata con successo.", "success"); 
                                    deleteResource(id, 'pagine');
