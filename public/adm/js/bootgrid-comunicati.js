$(document).ready(function(){
                ...
                }).on("loaded.rs.jquery.bootgrid", function()
                {
                    ...
                    {
                        window.location.href = "/admin/farmaco-vigilanza/comunicati/" + $(this).data("row-id") + "/modifica";
                    ...
                    }).end().find(".command-delete").on("click", function(e)
                    {
                            ...
                            rows[0] = id;
                                ...
                                swal({   
                                    title: "Sei sicuro di voler cancellare questo comunicato?",   
                                    ...
                                    swal("Cancellato!", "Il comunicato è stato cancellato con successo.", "success"); 
                                    deleteResource(id, 'farmaco-vigilanza/comunicati');
