@if(strlen($news->immagine_path) > 1)

<div class="fileinput fileinput-new" data-provides="fileinput">
    <div class="fileinput-preview thumbnail" data-trigger="fileinput" style="line-height:150px"><img src="/images/{{$news->immagine_path}}"></div>
    <div>
