<header id="header">
            <ul class="header-inner">
                ...
                <li class="logo hidden-xs">
                    <a href="/admin">Ibi-Lorenzini | Admin</a>
                </li>
                    ...
                    <li class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-lg pull-right">
                            <div class="listview" id="notifications">
                                ...
                                <div class="lv-body">
                                @foreach($lista_utenti_in_attesa as $utente_attesa)
                                    <a class="lv-item" href="/admin/medici-farmacisti/{{$utente_attesa->id}}">
                                        <div class="media">
                                            <div class="pull-left">
                                                <button class="btn btn-success btn-icon waves-effect waves-circle waves-float"><i class="zmdi zmdi-accounts-add"></i></button>
                                            </div>
