...
@include('admin.layouts.breadcrumbs', array('segments' => ['Utenti', 'Modifica']))
...
<section id="content">
    <div class="container">
        ...
        <form role="form" method="POST" action="/admin/utenti/{{$utente->id}}" enctype="multipart/form-data">
                ...
                <div class="card-body card-padding">
                    <form role="form">
                        <div class="form-group fg-line">
                            ...
                            <input type="text" class="form-control input-sm" value="{{$utente->first_name}}" name="first_name" id="first_name" placeholder="" required>
                        </div>
                        <div class="form-group fg-line">
                            <label for="last_name">Cognome</label>
                            <input type="text" class="form-control input-sm" value="{{$utente->last_name}}"  name="last_name" id="last_name" placeholder="" required>
                        </div>
                        <div class="form-group fg-line">
                            <label for="email">Email</label>
                            <input type="email" class="form-control input-sm" name="email" value="{{$utente->email}}"  id="email" placeholder="" required>
                        </div>
                        ...
                        <div class="form-group fg-line">
                            ...
                            @include('admin.acl.utenti.ruoli_partial', array('selected' => array_pluck($utente->roles, 'id')))
                        </div>


                        <div class="checkbox">
                            <label>
                                <input type="checkbox" name="active" @if($utente->active == 1) checked @endif>
