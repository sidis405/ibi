  ...
  <body id="top">
    ...
    <section class="content">
      <div class="container">
        <div class="row">
          <div class="col-md-8">
            <h2 id="home_main_article_title">IBI: 90 anni di esperienza</h2>
            <h3  id="home_main_article_subtitle">La nostra storia, i nostri valori</h3>
            <img src="/img/home-content-img.jpg" class="img-responsive">
            <div  id="home_main_article_body">
            <p>L’Istituto Biochimico Italiano, Ibi, fondato dal Prof. Giovanni Lorenzini, è un’azienda farmaceutica di grande tradizione scientifica presente sul mercato italiano da più di 90 anni, con obiettivi di ricerca, innovazione e produzione. Oltre la tradizione storica aziendale, le nuove tecnologie applicate e un’attenta cura nella produzione, fanno della Ibi sinonimo di affidabilità e garanzia di alta qualità nei paesi in cui l’Azienda è presente.</p>
                        ...
                        <p>La sede si trova ad Aprilia dove, oltre allo stabilimento di produzione, sono collocate tutte le funzioni aziendali. La produzione e il controllo qualità sono il core business dell’Azienda, a cui si affiancano Ricerca e Sviluppo, Farmacovigilanza...</p></div>
