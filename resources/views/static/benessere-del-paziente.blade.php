...
<html lang="en">
  <head>
    <title>Ibi Lorenzini | Per il benessere del paziente</title>
    <meta charset="utf-8">
              ...
              <div class="tab-content">
                  ...
                  <div id="accordion" role="tablist" aria-multiselectable="true" class="panel-group">
                    ...
                    <div class="panel panel-default"><a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo" class="collapsed">
                        <div id="headingTwo" role="tab" class="panel-heading">
                          <h4 class="panel-title">Epidemiologia, cause e storia naturale</h4>
                          <div class="plus-minus"></div>
                        </div></a>
                      <div id="collapseTwo" role="tabpanel" aria-labelledby="headingTwo" class="panel-collapse collapse">
                        <div class="panel-body">
                          <p>La Steatosi epatica non alcolica è presente nel 10-25% della popolazione generale, quindi in media 1 italiano su 4 ne soffre; tali percentuali aumentano in modo significativo nei pazienti obesi, fino a valori del 50-90%.</p>
                          <p>L’entità di questo problema non è da sottovalutare, non solo perché la percentuale di obesi nel nostro paese è significativa (18%) ma soprattutto perché si osserva da anni un trend di progressivo aumento (vedi confronto tra anni ’90 e primi anni del 2000 con un aumento degli obesi dal 10 al 18%, ovviamente associato anche ad un aumento del numero delle persone in sovrappeso).</p><img src="http://placehold.it/750x350" alt="" class="img-responsive">
                          <p>La steatosi, se si attuano le opportune misure eliminando le cause che l’hanno prodotta, è un danno stabile o reversibile. Purtroppo, essendo un danno iniziale, non facilmente diagnosticabile per la mancanza di segni e sintomi clinici evidenti, può evolvere in steatoepatite.</p>
                          <p>La Steatoepatite è presente nel 5-10% dei pazienti con NAFLD e si instaura per la costante presenza delle cause/fattori di rischio che hanno condotto alla NAFLD. Tali cause/fattori di rischio sono legate principalmente ad una non corretta alimentazione e allo stile di vita, fattori che inevitabilmente portano ad obesità, ipercolesterolemia, ipertrigliceridemia, insulino-resistenza e diabete tipo 2. Oltre queste cause/fattori di rischio più comuni la NAFLD si riscontra in seguito a farmaci assunti cronicamente o tossici per il fegato, diete ipocaloriche drastiche non bilanciate, disordini metabolici ereditari, danno intestinale. Non ultima causa di NAFLD è l’epatite da virus C.</p>
                          <p>La steatoepatite progredisce più o meno lentamente verso la fibrosi e la cirrosi. Inoltre, è spesso associata a un aumentato rischio di malattia cardiovascolare e diabete mellito di tipo 2. </p>
                          <p>Negli ultimi anni si sta valutando attentamente quanti pazienti affetti dall’epatopatia cronica possano andare incontro all' epatocarcinoma, senza necessariamente avere una cirrosi, legata ai virus dell’epatite virale C.												</p>
                        </div>
                      </div>
                    </div>
                    <div class="panel panel-default"><a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseThree" aria-expanded="false" aria-controls="collapseThree" class="collapsed">
                        <div id="headingThree" role="tab" class="panel-heading">
                          <h4 class="panel-title">	Sintomatologia e segni clinici</h4>
                          <div class="plus-minus"></div>
                        </div></a>
                      <div id="collapseThree" role="tabpanel" aria-labelledby="headingThree" class="panel-collapse collapse">
                        <div class="panel-body">
                          ...
                          </p><img src="http://placehold.it/750x350" alt="" class="img-responsive">
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="panel panel-default"><a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseFive" aria-expanded="false" aria-controls="collapseFive" class="collapsed">
                      ...
                      <div id="collapseFive" role="tabpanel" aria-labelledby="headingFive" class="panel-collapse collapse">
                        <div class="panel-body">
                          <p>Da sempre si è cercato di ottenere informazioni sullo stato funzionale e sull' architettura del fegato utilizzando le informazioni derivate da indagini non invasive (ad es. l’ecografia e gli esami del sangue), tuttavia al momento nessun test ematico da solo è in grado di dare una risposta completa. Negli ultimi anni si è cercato di ovviare a questo problema studiando la possibile combinazione di dati generali del paziente al fine di ottenere una risposta “indiretta”.</p>
                          <p>
                            ...
                            FIBROTEST
                            Rappresenta la combinazione di marcatori indiretti più studiata finora, prevede la combinazione di esami del sangue quali GGT, bilirubina totale, aptoglobina, α1 e α2 macroglobulina.
                          </p>
                          <p>Fibrotest può essere utilizzato per pazienti con epatite virale, alcolica o metabolica per la valutazione del danno epatico. Permette di classificare i pazienti per stadio oltre a determinare l’attività necroinfiammatoria virale.</p>
                          <p><b>Fibromax</b>Il FibroMax fornisce informazioni sul grado di steatosi, flogosi e fibrosi. Questo test utilizza un sistema basato su alcuni parametri del paziente come sesso, età, peso, altezza e alcuni esami del sangue (α2macroglobulina, aptoglobulina, apolipoproteina A1, bilirubina totale, AST, ALT, GGT, glicemia a digiuno, trigliceridi e colesterolo totale).
                    ...
                    <div class="panel panel-default"><a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseSix" aria-expanded="false" aria-controls="collapseSix" class="collapsed">
                      ...
                      <div id="collapseSix" role="tabpanel" aria-labelledby="headingSix" class="panel-collapse collapse">
                        <div class="panel-body">
                          <p>
                            Non esiste ad oggi una terapia standardizzata della NAFLD.
                            Modificare il proprio stile di vita è fondamentale per una significativa riduzione della steatosi e una normalizzazione degli esami clinici. L’utilizzo di integratori antiossidanti è utile per prevenire l’evoluzione del danno, recuperare la funzionalità epatica, riequilibrare il metabolismo.
                          </p>
                          <p>RealSIL, un integratore, a base di silibina con fosfolipidi e vitamina E, protegge gli epatociti dal danno infiammatorio dei radicali liberi, come stabilizzatore di membrana e antiossidante naturale, ed è in grado di “depurare il fegato grasso” e rallentarne il danno, riequilibrando l’assetto metabolico, alla base dell’accumulo di grassi nel fegato. Dagli studi fatti con RealSIL si è visto che il prodotto normalizza gli indici di funzionalità epatica (ALT e YGT), riduce il grado di steatosi epatica, contrasta l’infiammazione epatica e sistemica, riduce l’iperglicemia e migliora la sensibilità all’insulina.</p>
                          <p>I risultati uno studio randomizzato in doppio cieco multicentrico finalizzato a dimostrare l’attività di questo integratore sono molto incoraggianti e indicano come le sostanze che lo compongono possano essere in grado di agire sulla malattia. Va inoltre sottolineata l’ottima tollerabilità e compliance per i pazienti, anche per dosaggi elevati e per lunghi periodi.</p>
                          <p>
                            Link utili
                ...
                <div id="meteorismo" role="tabpanel" class="tab-pane">
                  ...
                  <p>
                    ...
                    Si manifesta con una sintomatologia caratterizzata inizialmente con fastidio addominale, senso di gonfiore e rumori intestinali (borborigmi), che, protraendosi nel tempo, possono complicarsi in forti dolori addominali e crampi.
                  </p>
                  <p>Il meteorismo si innesca durante il processo digestivo, quando gli zuccheri e la cellulosa “fermentano” nell’intestino, con la conseguente formazione di azoto, metano e anidride carbonica.</p>
                  <p>
                  ...
                  <p>Questo disturbo, dovuto alla formazione di bollicine d’aria nella saliva, che vengono di seguito ingerite, dipende spesso da cattive abitudini come mangiare velocemente, masticare a lungo un chewing-gum o fumare.</p>
                  <h4>La soluzione</h4>
                  <p>Oltre a modificare il proprio stile di vita e abitudini alimentari, Meteosim può rappresentare una valida soluzione al meteorismo e all’aerofagia. È un medicinale di automedicazione che favorisce l’eliminazione dei gas nel tratto gastrointestinale.</p>
                  <p>L’efficacia di Meteosim è dovuta all’azione del simeticone (dimeticone attivato), una miscela di polimeri di silicone combinati con diossido di silicio, che agisce localmente nell’apparato gastrointestinale ed è capace di abbassare la tensione superficiale “sequestrando” il gas in eccesso e favorendone l’eliminazione.</p>
                  <p>Il simeticone fa in modo che le bolle di gas presenti confluiscano per poi essere eliminate più facilmente alleviando i fastidiosi sintomi associati al meteorismo e all’aerofagia.</p>
                  <p>
                    Il simeticone non viene assorbito dall’organismo e non interferisce sull’assorbimento delle sostanze nutritive agendo pertanto solo sui gas.
                    L’ampio campione di pazienti trattati in oltre 40 anni di utilizzo e l’elevato numero di studi disponibili testimoniano l’efficacia di simeticone nel ridurre la sintomatologia da eccessiva presenza di aria nel tratto gastrointestinale, indicazione confermata dalla Food and Drug Administration già nel 1973.
                  </p>
                  <p>Meteosim - simeticone - si può usare per curare disturbi lievi e transitori, facilmente riconoscibili e risolvibili: può essere quindi acquistato senza ricetta ma va usato correttamente per assicurarne l’efficacia. Il medicinale non presenta particolari controindicazioni, salvo per ipersensibilità al principio attivo o ad altri componenti del prodotto. È generalmente controindicato nelle donne in gravidanza.</p>
                  <p>
                    Meteosim compresse masticabili
                    La posologia suggerita per gli adulti è di 4 compresse al giorno, dopo i pasti o secondo prescrizione medica
                    Simeticone IBI, bambini gocce orali, sospensione
                    La posologia suggerita per i bambini è di 15 gocce, 2-4 volte al dì, dopo i pasti o secondo prescrizione medica						
                  </p>
                </div>
              </div>
            </div>
