	...
	<tr>
		<td style="font-family: 'Droid Sans', Arial, sans-serif; padding-top: 0;" align="left" valign="top">
			<p style="font-size: 14px;">
				Per visualizzare tutte le informazioni relative a questa registrazione <a href="http://www.ibi-lorenzini.it/admin/medici-farmacisti/{{$utente['id']}}">clicca qui</a>
			</p>
		</td>
	</tr>
</table>
