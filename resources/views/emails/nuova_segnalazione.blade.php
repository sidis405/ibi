...
<table border="0" cellpadding="20" cellspacing="0" width="100%" id="emailBody">
	<tr>
		<td style="font-family: 'Droid Sans', Arial, sans-serif; padding-bottom: 0;" align="left" valign="top">
			<h2 style="color: #00509a; font-weight: 100; margin-top: 0;">Una nuova Segnalazione Farmaco Vigilanza ibi-lorenzini.com</h2>
	...
	<tr>
		<td style="font-family: 'Droid Sans', Arial, sans-serif; padding-top: 0;" align="left" valign="top">
			<p style="font-size: 14px;">
				Per visualizzare tutte le informazioni relative a questa segnalazione <a href="http://demo.ibi-lorenzini.com/admin/farmaco-vigilanza/segnalazioni/{{$segnalazione['id']}}">clicca qui</a>
			</p>
		</td>
	</tr>
</table>
