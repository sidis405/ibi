...
<div class="col-lg-6 col-md-12 mix ct-{{$prodotto->categoria_terapeutica->slug}} pa-{{$prodotto->principio_attivo->slug}} {{str_slug($prodotto->nome)}} {{$prodotto->aic}} {{$prodotto->aic}}">
  <div class="product">
